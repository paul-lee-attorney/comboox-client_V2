...
import { useWaterfallsGetGulfInfo } from "../../../../../../../generated";
...
export function GulfInfo({setInfo, setList}:ActionsOfDistrProps) {
  ...
  const {
    isLoading: getGulfInfoLoading,
    refetch:getGulfInfo,
  } = useWaterfallsGetGulfInfo({
    ...
    onSuccess(data) {
      setLoading(true);
      let info = {...data, name: 'Gulf Info of Class'};
      setInfo(info);
      setLoading(false);
    }
  });
  ...
  return (
    ...
    >
      ...
      <Stack direction={'row'} sx={{ alignItems:'start'}} >
        ...
        <LoadingButton 
          disabled = { classOfShare == '0' || getGulfInfoLoading || hasError(valid)}
          loading={loading}
          loadingPosition="end"
