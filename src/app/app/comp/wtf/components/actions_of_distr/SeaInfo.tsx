...
import { QueryBuilderOutlined, QueryStatsOutlined, SearchOutlined } from "@mui/icons-material";
import { useWaterfallsGetInitSeaInfo, useWaterfallsGetSeaInfo } from "../../../../../../../generated";
...
export function SeaInfo({setInfo, setList}:ActionsOfDistrProps) {
  ...
  const {
    ...
    onSuccess(data) {
      setLoading(true);
      let info = {...data, name: 'Sea Info of Class'};
      setInfo(info);
      setLoading(false);
    }
  });
  ...
  return (
    ...
    >
      ...
      <Stack direction={'row'} sx={{ alignItems:'start'}} >
        ...
        <LoadingButton 
          disabled = { classOfShare == '0' || getSeaInfoLoading || hasError(valid) }
          loading={loading}
          loadingPosition="end"
